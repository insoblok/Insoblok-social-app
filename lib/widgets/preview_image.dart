...
class _PreviewImgPageState extends State<PreviewImgPage> {
  ...
  Future<void> handleClickExit() async {
    final Directory tempDir = await getTemporaryDirectory();
    final now = DateTime.now().millisecondsSinceEpoch;
    final String filePath = "${tempDir.path}/my_image_$now.jpg";
    final file = File(filePath);
    await file.writeAsBytes(_imageBytes);
    logger.d("generated file path is ${file.path}");
    mediaPickerService.editedImagePath = file.path;
