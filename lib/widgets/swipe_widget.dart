...
import 'package:insoblok/widgets/swipe_direction.dart';
...
class SwipeWidget extends StatefulWidget {
  ...
  @override
  State<SwipeWidget> createState() => _SwipeTutorialState();
}

class _SwipeTutorialState extends State<SwipeWidget>
  ...
  Widget _icon() {
    ...
    switch (widget.swipeDirection) {
      case SwipeDirection.rightToLeft:
        return const Icon(Icons.swipe_left, color: Colors.white, size: 50);
      case SwipeDirection.leftToRight:
        return const Icon(Icons.swipe_right, color: Colors.white, size: 50);
      case SwipeDirection.topToBottom:
        return const Icon(Icons.swipe_down, color: Colors.white, size: 50);
      case SwipeDirection.bottomToTop:
        return const Icon(Icons.swipe_up, color: Colors.white, size: 50);
    }
  }
        ...
        AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            return Container(
              ...
              child: Opacity(
                opacity: opacity,
                child: Align(alignment: _getAlignment(), child: _icon()),
              ),
            );
          },
        ),
