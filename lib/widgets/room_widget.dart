                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                if(room.userSettings.isMuted ?? false) ...{
                                                  Icon(
                                                    Icons.volume_off,
                                                    color: Colors.white,
                                                    size: 16.0,
                                            ...
                                            Text(
                                              room.chatroom.updatedAt?.timeago ?? '',
                                              style: const TextStyle(
                                                fontSize: 14.0,
                                                color: Colors.grey,
                                              ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              room.chatroom.content =="null" ? 'New Chat Room' : room.chatroom.content ?? "",
                                            ...
                                            Opacity(
                                              opacity: viewModel.unreadMsgCnt > 0
                                                  ? 1
                                                  : 0,
                                              child: Row(
                                                children: [
