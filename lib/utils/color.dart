...
class AIColors {
  static Color darkBar = Color(0xff223448); // 34 52 72
  static Color darkScaffoldBackground = Color(0xff1c2836); // 28 40 54
  static Color landingBackgroundColor = Color(0xFF120138);
  ...
  static Color lightTransparentBackground = Colors.white54;
