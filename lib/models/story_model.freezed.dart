...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StoryModel&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.text, text) || other.text == text)&&(identical(other.status, status) || other.status == status)&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other.likes, likes)&&const DeepCollectionEquality().equals(other.follows, follows)&&const DeepCollectionEquality().equals(other.views, views)&&(identical(other.placeId, placeId) || other.placeId == placeId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&const DeepCollectionEquality().equals(other.connects, connects)&&const DeepCollectionEquality().equals(other.comments, comments)&&const DeepCollectionEquality().equals(other.allowUsers, allowUsers)&&const DeepCollectionEquality().equals(other.reactions, reactions)&&const DeepCollectionEquality().equals(other.votes, votes)&&const DeepCollectionEquality().equals(other.medias, medias));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,text,status,category,const DeepCollectionEquality().hash(likes),const DeepCollectionEquality().hash(follows),const DeepCollectionEquality().hash(views),placeId,createdAt,updatedAt,deletedAt,const DeepCollectionEquality().hash(connects),const DeepCollectionEquality().hash(comments),const DeepCollectionEquality().hash(allowUsers),const DeepCollectionEquality().hash(reactions),const DeepCollectionEquality().hash(votes),const DeepCollectionEquality().hash(medias)]);

@override
String toString() {
  return 'StoryModel(id: $id, userId: $userId, title: $title, text: $text, status: $status, category: $category, likes: $likes, follows: $follows, views: $views, placeId: $placeId, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, connects: $connects, comments: $comments, allowUsers: $allowUsers, reactions: $reactions, votes: $votes, medias: $medias)';
}
...
@useResult
$Res call({
 String? id, String? userId, String? title, String? text, String? status, String? category, List<String>? likes, List<String>? follows, List<String>? views, String? placeId, DateTime? createdAt, DateTime? updatedAt, DateTime? deletedAt, List<ConnectedStoryModel>? connects, List<String>? comments, List<String>? allowUsers, List<String>? reactions, List<StoryVoteModel>? votes, List<MediaStoryModel>? medias
});
...
/// Create a copy of StoryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? userId = freezed,Object? title = freezed,Object? text = freezed,Object? status = freezed,Object? category = freezed,Object? likes = freezed,Object? follows = freezed,Object? views = freezed,Object? placeId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? connects = freezed,Object? comments = freezed,Object? allowUsers = freezed,Object? reactions = freezed,Object? votes = freezed,Object? medias = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? userId,  String? title,  String? text,  String? status,  String? category,  List<String>? likes,  List<String>? follows,  List<String>? views,  String? placeId,  DateTime? createdAt,  DateTime? updatedAt,  DateTime? deletedAt,  List<ConnectedStoryModel>? connects,  List<String>? comments,  List<String>? allowUsers,  List<String>? reactions,  List<StoryVoteModel>? votes,  List<MediaStoryModel>? medias)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StoryModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.text,_that.status,_that.category,_that.likes,_that.follows,_that.views,_that.placeId,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.connects,_that.comments,_that.allowUsers,_that.reactions,_that.votes,_that.medias);case _:
  return orElse();
...
class _StoryModel implements StoryModel {
   _StoryModel({this.id, this.userId, this.title, this.text, this.status, this.category, final  List<String>? likes, final  List<String>? follows, final  List<String>? views, this.placeId, this.createdAt, this.updatedAt, this.deletedAt, final  List<ConnectedStoryModel>? connects, final  List<String>? comments, final  List<String>? allowUsers, final  List<String>? reactions, final  List<StoryVoteModel>? votes, final  List<MediaStoryModel>? medias}): _likes = likes,_follows = follows,_views = views,_connects = connects,_comments = comments,_allowUsers = allowUsers,_reactions = reactions,_votes = votes,_medias = medias;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StoryModel&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.text, text) || other.text == text)&&(identical(other.status, status) || other.status == status)&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other._likes, _likes)&&const DeepCollectionEquality().equals(other._follows, _follows)&&const DeepCollectionEquality().equals(other._views, _views)&&(identical(other.placeId, placeId) || other.placeId == placeId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&const DeepCollectionEquality().equals(other._connects, _connects)&&const DeepCollectionEquality().equals(other._comments, _comments)&&const DeepCollectionEquality().equals(other._allowUsers, _allowUsers)&&const DeepCollectionEquality().equals(other._reactions, _reactions)&&const DeepCollectionEquality().equals(other._votes, _votes)&&const DeepCollectionEquality().equals(other._medias, _medias));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,text,status,category,const DeepCollectionEquality().hash(_likes),const DeepCollectionEquality().hash(_follows),const DeepCollectionEquality().hash(_views),placeId,createdAt,updatedAt,deletedAt,const DeepCollectionEquality().hash(_connects),const DeepCollectionEquality().hash(_comments),const DeepCollectionEquality().hash(_allowUsers),const DeepCollectionEquality().hash(_reactions),const DeepCollectionEquality().hash(_votes),const DeepCollectionEquality().hash(_medias)]);
...
as List<String>?,reactions: freezed == reactions ? _self._reactions : reactions // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MediaStoryModel&&(identical(other.link, link) || other.link == link)&&(identical(other.thumb, thumb) || other.thumb == thumb)&&(identical(other.type, type) || other.type == type)&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.publicId, publicId) || other.publicId == publicId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,link,thumb,type,width,height,publicId);

@override
String toString() {
  return 'MediaStoryModel(link: $link, thumb: $thumb, type: $type, width: $width, height: $height, publicId: $publicId)';
}
...
@useResult
$Res call({
 String? link, String? thumb, String? type, double? width, double? height, String? publicId
});
...
/// Create a copy of MediaStoryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? link = freezed,Object? thumb = freezed,Object? type = freezed,Object? width = freezed,Object? height = freezed,Object? publicId = freezed,}) {
  return _then(_self.copyWith(
...
as double?,publicId: freezed == publicId ? _self.publicId : publicId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? link,  String? thumb,  String? type,  double? width,  double? height,  String? publicId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaStoryModel() when $default != null:
return $default(_that.link,_that.thumb,_that.type,_that.width,_that.height,_that.publicId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? link,  String? thumb,  String? type,  double? width,  double? height,  String? publicId)  $default,) {final _that = this;
switch (_that) {
case _MediaStoryModel():
return $default(_that.link,_that.thumb,_that.type,_that.width,_that.height,_that.publicId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? link,  String? thumb,  String? type,  double? width,  double? height,  String? publicId)?  $default,) {final _that = this;
switch (_that) {
case _MediaStoryModel() when $default != null:
return $default(_that.link,_that.thumb,_that.type,_that.width,_that.height,_that.publicId);case _:
  return null;
...
/// Create a copy of MediaStoryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? link = freezed,Object? thumb = freezed,Object? type = freezed,Object? width = freezed,Object? height = freezed,Object? publicId = freezed,}) {
