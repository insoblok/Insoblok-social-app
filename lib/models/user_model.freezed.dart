...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,uid,walletAddress,avatar,firstName,lastName,email,password,city,country,website,desc,discovery,nickId,lat,lon,ipAddress,updateDate,timestamp,status,hasVotePost,freeStyle,isPremium,rewardDate,transferedXP,transferedInSo,const DeepCollectionEquality().hash(_likes),const DeepCollectionEquality().hash(_follows),const DeepCollectionEquality().hash(_views),const DeepCollectionEquality().hash(_userActions),const DeepCollectionEquality().hash(_galleries),const DeepCollectionEquality().hash(_actions)]);
