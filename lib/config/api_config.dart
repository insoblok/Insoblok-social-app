...
class ApiConfig {
  ...
  static const String tatumApiKey = String.fromEnvironment(
    'TATUM_API_KEY',
    defaultValue: 't-68fe5ff12b646d64aa69f200-355086d8704d43d7964ef033',
  );

  static const String tatumBaseUrl = String.fromEnvironment(
    'TATUM_BASE_URL',
    defaultValue: 'https://api.tatum.io',
  );

  static const String tatumCardanoBaseUrl = String.fromEnvironment(
    'TATUM_CARDANO_BASE_URL',
    defaultValue: 'https://cardano-mainnet.gateway.tatum.io',
  );
}
