...
class AccountHeaderInitView extends ViewModelWidget<AccountProvider> {
...
class AccountHeaderReadyView extends ViewModelWidget<AccountProvider> {
...
class AccountBodyInitView extends ViewModelWidget<AccountProvider> {
